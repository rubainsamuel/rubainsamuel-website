...
date: 2026-08-19
description: "As information becomes easier to obtain and explanations easier to generate, the harder question is no longer what else we can know, but what genuinely improves our judgment."
...
Later [research](https://doi.org/10.1016/j.obhdp.2008.01.005) by Claire Tsai, Joshua Klayman and Reid Hastie found a similar pattern across three experiments. Additional judgment-relevant information could improve accuracy, but confidence increased more rapidly, creating a growing gap between how certain people felt and how accurate their judgments actually were.

The interesting part is not that information sometimes fails to help. Often it does help. It is that the feeling of understanding can improve faster than the judgment itself.

Perhaps more information does two things at once. It can improve our understanding of the world, but it can also improve the story we are able to tell ourselves about our understanding. Those are not necessarily the same thing.

## More information makes the story feel more complete

Information rarely arrives into an empty mind.

By the time we ask for another analysis, we usually have some sense of what might be happening. Sales may be slowing because the price is too high; a campaign may be underperforming because the creative is weak; a market may look attractive because demand appears to be growing.

At first, these are hypotheses. But as information accumulates, something subtle can happen: the hypothesis begins organising the evidence around itself. A customer comment, a competitor move or a particular cut of the data appears consistent with the emerging explanation, while evidence that does not fit can begin to look like an exception. Gradually, what started as one possible explanation can start to feel like *the* explanation.
...
The question, then, is not simply whether we have more information. It is whether the additional information is testing our explanation, or merely making it easier to believe.

## We confuse more information with more useful information

Even when additional information tests our explanation, another question remains: is it actually capable of improving the decision?
...
There is something recognisable in that behaviour. Once we have gone looking for a piece of information, it becomes harder to treat what we find as irrelevant.

This matters in organisations because “we need more data” does not always mean the same thing. Sometimes there is a genuine uncertainty that additional evidence could resolve. At other times, it may mean we are simply not yet comfortable making the decision.

The first problem is informational. The second is psychological.
...
So the more useful question is not simply, “What else can we know?” but, “What could we learn that would actually change what we believe or what we do?”

## Information quantity is easier to see than information quality

Even when information could matter to the decision, another problem remains: it is much easier to see how much information we have than how much signal it contains.

We can see that a dashboard has thirty metrics instead of five, that a market study contains hundreds of responses, or that an analysis draws on ten different sources. What is harder to judge is whether those additional pieces of information are genuinely independent, diagnostic or relevant to the decision.

That distinction matters because more evidence is not always more signal.

Crystal Hall, Lynn Ariss and Alexander Todorov demonstrated this in a series of [experiments](https://collaborate.princeton.edu/en/publications/the-illusion-of-knowledge-when-more-information-reduces-accuracy-/) involving predictions of basketball games. Participants were given useful statistics such as team records and halftime scores. Some were also shown the names of the teams. That additional information made knowledgeable basketball fans more confident in their predictions, but less accurate, because familiarity with particular teams drew attention away from the more predictive statistical cues.
...
With enough variables, customer segments, anecdotes and contextual detail, almost any business outcome can be made to look understandable after the fact. Revenue fell because pricing changed, because a competitor moved, because the customer mix shifted, because the market softened, because execution was uneven. The more information we have, the easier it becomes to build a story in which everything seems to fit.
...
Confidence can come from coherence, familiarity, detail, consensus or simply having spent a long time with a problem. Accuracy depends on something less comfortable: whether our understanding actually corresponds with what happens in the world.

Daniel Kahneman and Gary Klein explored this distinction in their [work](https://pubmed.ncbi.nlm.nih.gov/19739881/) on expert intuition. Despite coming from different traditions, they agreed that reliable expertise is most likely to develop under two conditions: the environment contains patterns that are sufficiently regular to learn, and people have repeated opportunities to receive feedback on their judgments. Subjective confidence on its own is not a reliable indication that those conditions exist.

That distinction matters in business because not all decisions offer the same quality of feedback.

In analytics, we often work on problems where the consequences become visible relatively quickly. A campaign runs, conversion changes, churn rises or falls, or a forecast can eventually be compared with what actually happened. Over time, those feedback loops give us opportunities to discover where our judgment was wrong and adjust it.

Strategy often operates in a much weaker feedback environment. A market-entry decision may take years to play out. Competitors respond, economic conditions change and there is rarely a clean counterfactual showing what would have happened had we chosen differently. By the time the outcome is visible, it can be difficult to separate the quality of the original decision from everything that happened afterwards.

Yet we may feel just as confident in both environments.
...
The distinction, then, is not between more and less information, but between information that improves the relationship between our beliefs and reality and information that mainly increases our confidence in those beliefs.
...
Used that way, AI does not simply reduce the cost of obtaining information. It can reduce the cost of challenging our own interpretation of it.

As answers become easier to produce, the advantage may shift towards knowing which questions an answer must survive before it deserves our confidence.
...
The more I have thought about it, the less I think the problem is information itself. Better information can improve decisions enormously. The harder problem is that information can also make our explanations more coherent, our models more elaborate and our confidence stronger without improving our understanding at the same rate.

Those effects are easy to confuse because, from inside the decision, they often feel the same.

Having spent years around data and insights, I do not come away from this wanting less analysis. If anything, I think the opposite. But I am becoming more demanding about what analysis is supposed to accomplish. The goal cannot simply be to make the picture fuller or the recommendation easier to defend. It should be to improve the connection between what we believe and what is actually true.
